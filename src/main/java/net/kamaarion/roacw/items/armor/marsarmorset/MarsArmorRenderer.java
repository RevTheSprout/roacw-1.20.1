...
public class MarsArmorRenderer extends GeoArmorRenderer<MarsArmorItem> {
    public MarsArmorRenderer(MarsArmorModel marsArmorModel) {
        super(new MarsArmorModel());
        this.addRenderLayer(new MarsArmorLayer(this));
    ...
    public RenderType getRenderType(MarsArmorItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
