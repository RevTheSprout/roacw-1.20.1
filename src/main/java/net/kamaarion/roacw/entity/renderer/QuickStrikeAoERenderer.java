...
public class QuickStrikeAoERenderer extends EntityRenderer<QuickStrikeAoE> {
    private static final ResourceLocation[] TEXTURES = {
            ROACW.id("textures/entity/quick_strike/quick_strike_1.png"),
            ROACW.id("textures/entity/quick_strike/quick_strike_2.png"),
            ROACW.id("textures/entity/quick_strike/quick_strike_3.png"),
            ROACW.id("textures/entity/quick_strike/quick_strike_4.png")
    };
